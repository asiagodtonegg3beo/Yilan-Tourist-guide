...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/app/AppCompatDialog;Landroid/view/Window;)V
    ...
    .line 101
    iput v4, p0, Landroidx/appcompat/app/AlertController;->mIconId:I
    ...
    .line 122
    iput v4, p0, Landroidx/appcompat/app/AlertController;->mButtonPanelLayoutHint:I
    ...
    sget-object v2, Landroidx/appcompat/R$styleable;->AlertDialog:[I

    sget v3, Landroidx/appcompat/R$attr;->alertDialogStyle:I
    ...
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_android_layout:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/app/AlertController;->mAlertDialogLayout:I

    .line 192
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_buttonPanelSideLayout:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/app/AlertController;->mButtonPanelSideLayout:I

    .line 194
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_listLayout:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/app/AlertController;->mListLayout:I

    .line 195
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_multiChoiceItemLayout:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/app/AlertController;->mMultiChoiceItemLayout:I

    .line 196
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_singleChoiceItemLayout:I
    ...
    iput v1, p0, Landroidx/appcompat/app/AlertController;->mSingleChoiceItemLayout:I

    .line 198
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_listItemLayout:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/app/AlertController;->mListItemLayout:I

    .line 199
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_showTitle:I
    ...
    .line 200
    sget v1, Landroidx/appcompat/R$styleable;->AlertDialog_buttonIconDimen:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/app/AlertController;->mButtonIconDimen:I

    .line 202
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    .line 205
    invoke-virtual {p2, v5}, Landroidx/appcompat/app/AppCompatDialog;->supportRequestWindowFeature(I)Z
...
.method private setScrollIndicators(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    invoke-direct {v5, p0, v3, v0}, Landroidx/appcompat/app/AlertController$2;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v5, p0, v3, v0}, Landroidx/appcompat/app/AlertController$3;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v5, p0, v3, v0}, Landroidx/appcompat/app/AlertController$4;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v5, p0, v3, v0}, Landroidx/appcompat/app/AlertController$5;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
...
.method private setupButtons(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v5}, Landroidx/appcompat/app/AlertController;->shouldCenterSingleButton(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v5}, Landroidx/appcompat/app/AlertController;->centerButton(Landroid/widget/Button;)V
    ...
    iget-object v6, p0, Landroidx/appcompat/app/AlertController;->mButtonPositiveText:Ljava/lang/CharSequence;
...
.method private setupContent(Landroid/view/ViewGroup;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/app/AlertController;->mScrollView:Landroidx/core/widget/NestedScrollView;

    .line 720
    iget-object v2, p0, Landroidx/appcompat/app/AlertController;->mScrollView:Landroidx/core/widget/NestedScrollView;

    invoke-virtual {v2, v5}, Landroidx/core/widget/NestedScrollView;->setFocusable(Z)V
    ...
    iput-object v2, p0, Landroidx/appcompat/app/AlertController;->mMessageView:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Landroidx/appcompat/app/AlertController;->mMessage:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2, v3}, Landroidx/core/widget/NestedScrollView;->removeView(Landroid/view/View;)V
...
.method private setupCustomContent(Landroid/view/ViewGroup;)V
    ...
    .line 640
    iget-object v4, p0, Landroidx/appcompat/app/AlertController;->mView:Landroid/view/View;

    if-eqz v4, :cond_5

    .line 641
    iget-object v1, p0, Landroidx/appcompat/app/AlertController;->mView:Landroid/view/View;
    ...
    invoke-static {v1}, Landroidx/appcompat/app/AlertController;->canTextInput(Landroid/view/View;)Z
    ...
    sget v5, Landroidx/appcompat/R$id;->custom:I
    ...
    .line 659
    iget-boolean v4, p0, Landroidx/appcompat/app/AlertController;->mViewSpacingSpecified:Z

    if-eqz v4, :cond_3

    .line 660
    iget v4, p0, Landroidx/appcompat/app/AlertController;->mViewSpacingLeft:I

    iget v5, p0, Landroidx/appcompat/app/AlertController;->mViewSpacingTop:I

    iget v6, p0, Landroidx/appcompat/app/AlertController;->mViewSpacingRight:I

    iget v7, p0, Landroidx/appcompat/app/AlertController;->mViewSpacingBottom:I
    ...
    :cond_5
    iget v4, p0, Landroidx/appcompat/app/AlertController;->mViewLayoutResId:I
...
.method private setupTitle(Landroid/view/ViewGroup;)V
    ...
    sget v4, Landroidx/appcompat/R$id;->title_template:I
    ...
    sget v4, Landroidx/appcompat/R$id;->alertTitle:I
    ...
    iget v4, p0, Landroidx/appcompat/app/AlertController;->mIconId:I
    ...
    iget-object v4, p0, Landroidx/appcompat/app/AlertController;->mIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v7, p0, Landroidx/appcompat/app/AlertController;->mIconView:Landroid/widget/ImageView;
...
.method private setupView()V
    ...
    sget v24, Landroidx/appcompat/R$id;->parentPanel:I
    ...
    sget v23, Landroidx/appcompat/R$id;->topPanel:I
    ...
    sget v23, Landroidx/appcompat/R$id;->contentPanel:I
    ...
    sget v23, Landroidx/appcompat/R$id;->buttonPanel:I
    ...
    sget v23, Landroidx/appcompat/R$id;->customPanel:I
    ...
    invoke-direct {v0, v10, v13}, Landroidx/appcompat/app/AlertController;->resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-direct {v0, v8, v12}, Landroidx/appcompat/app/AlertController;->resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-direct {v0, v7, v11}, Landroidx/appcompat/app/AlertController;->resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-direct {v0, v6}, Landroidx/appcompat/app/AlertController;->setupContent(Landroid/view/ViewGroup;)V

    .line 487
    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Landroidx/appcompat/app/AlertController;->setupButtons(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, v1}, Landroidx/appcompat/app/AlertController;->setupTitle(Landroid/view/ViewGroup;)V
    ...
    .line 500
    sget v23, Landroidx/appcompat/R$id;->textSpacerNoButtons:I
    ...
    invoke-virtual/range {v23 .. v24}, Landroidx/core/widget/NestedScrollView;->setClipToPadding(Z)V
    ...
    .line 516
    :cond_2
    sget v23, Landroidx/appcompat/R$id;->titleDividerNoCustom:I
    ...
    check-cast v23, Landroidx/appcompat/app/AlertController$RecycleListView;

    move-object/from16 v0, v23

    move/from16 v1, v17

    invoke-virtual {v0, v1, v15}, Landroidx/appcompat/app/AlertController$RecycleListView;->setHasDecor(ZZ)V
    ...
    invoke-direct {v0, v6, v5, v1, v2}, Landroidx/appcompat/app/AlertController;->setScrollIndicators(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    .line 524
    sget v23, Landroidx/appcompat/R$id;->textSpacerNoTitle:I
