...
.method constructor <init>()V
    ...
    .line 76
    iput v1, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mCurIndex:I
...
.method private initializeDrawableForDisplay(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v2}, Landroidx/appcompat/graphics/drawable/DrawableContainer$BlockInvalidateCallback;->unwrap()Landroid/graphics/drawable/Drawable$Callback;
...
.method animate(Z)V
    ...
    iput-boolean v4, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mHasAlpha:Z
    ...
    iget-object v4, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mCurrDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_4

    .line 542
    iget-wide v4, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mEnterAnimationEnd:J
    ...
    .line 574
    iget-object v4, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mAnimationRunnable:Ljava/lang/Runnable;

    const-wide/16 v6, 0x10

    add-long/2addr v6, v2

    invoke-virtual {p0, v4, v6, v7}, Landroidx/appcompat/graphics/drawable/DrawableContainer;->scheduleSelf(Ljava/lang/Runnable;J)V
    ...
    iget v6, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mAlpha:I
...
.method public getPadding(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v4}, Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;->getConstantPadding()Landroid/graphics/Rect;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 619
    iget-boolean v1, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mMutated:Z
...
.method selectDrawable(I)Z
    ...
    .line 430
    iget v5, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mCurIndex:I
    ...
    .line 440
    iget-object v5, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mLastDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, p1}, Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;->getChild(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    :goto_2
    iget-wide v6, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mEnterAnimationEnd:J
    ...
    .line 470
    :cond_5
    iget-object v1, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mAnimationRunnable:Ljava/lang/Runnable;

    if-nez v1, :cond_a

    .line 471
    new-instance v1, Landroidx/appcompat/graphics/drawable/DrawableContainer$1;

    invoke-direct {v1, p0}, Landroidx/appcompat/graphics/drawable/DrawableContainer$1;-><init>(Landroidx/appcompat/graphics/drawable/DrawableContainer;)V

    iput-object v1, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mAnimationRunnable:Ljava/lang/Runnable;
    ...
    .line 448
    :cond_7
    iput-object v11, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mLastDrawable:Landroid/graphics/drawable/Drawable;

    .line 449
    iput v10, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mLastIndex:I
    ...
    .line 452
    :cond_8
    iget-object v5, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mCurrDrawable:Landroid/graphics/drawable/Drawable;
    ...
    .line 466
    :cond_9
    iput-object v11, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mCurrDrawable:Landroid/graphics/drawable/Drawable;

    .line 467
    iput v10, p0, Landroidx/appcompat/graphics/drawable/DrawableContainer;->mCurIndex:I
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/graphics/drawable/DrawableContainer;->unscheduleSelf(Ljava/lang/Runnable;)V
