...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mTempRect:Landroid/graphics/Rect;
    ...
    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextPaint:Landroid/text/TextPaint;
    ...
    invoke-static {p1, p2, v8, p3, v9}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;

    move-result-object v0

    .line 227
    .local v0, "a":Landroidx/appcompat/widget/TintTypedArray;
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_android_thumb:I

    invoke-virtual {v0, v8}, Landroidx/appcompat/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mThumbDrawable:Landroid/graphics/drawable/Drawable;
    ...
    .line 231
    :cond_0
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_track:I

    invoke-virtual {v0, v8}, Landroidx/appcompat/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    .line 235
    :cond_1
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_android_textOn:I

    invoke-virtual {v0, v8}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v8

    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextOn:Ljava/lang/CharSequence;

    .line 236
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_android_textOff:I

    invoke-virtual {v0, v8}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v8

    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextOff:Ljava/lang/CharSequence;

    .line 237
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_showText:I

    const/4 v9, 0x1

    invoke-virtual {v0, v8, v9}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    .line 238
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTextPadding:I

    const/4 v9, 0x0

    invoke-virtual {v0, v8, v9}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    .line 240
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_switchMinWidth:I
    ...
    .line 242
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_switchPadding:I
    ...
    .line 244
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_splitTrack:I
    ...
    .line 246
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTint:I

    invoke-virtual {v0, v8}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    .line 251
    :cond_2
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTintMode:I

    const/4 v9, -0x1

    .line 252
    invoke-virtual {v0, v8, v9}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I
    ...
    .line 266
    :cond_6
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_trackTintMode:I
    ...
    .line 276
    :cond_9
    sget v8, Landroidx/appcompat/R$styleable;->SwitchCompat_switchTextAppearance:I

    const/4 v9, 0x0

    invoke-virtual {v0, v8, v9}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I
    ...
    iput v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mTouchSlop:I
    ...
    iput v8, p0, Landroidx/appcompat/widget/SwitchCompat;->mMinFlingVelocity:I
    ...
    invoke-virtual {p0, v8}, Landroidx/appcompat/widget/SwitchCompat;->setChecked(Z)V
