...
.method private static addColorStateListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 148
    sget-object v2, Landroidx/appcompat/content/res/AppCompatResources;->sColorStateCacheLock:Ljava/lang/Object;
    ...
    .line 150
    .local v0, "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;>;"
    if-nez v0, :cond_0

    .line 151
    new-instance v0, Landroid/util/SparseArray;

    .end local v0    # "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;>;"
    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    .line 152
    .restart local v0    # "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;>;"
    sget-object v1, Landroidx/appcompat/content/res/AppCompatResources;->sColorStateCaches:Ljava/util/WeakHashMap;
...
.method private static getCachedColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 128
    sget-object v3, Landroidx/appcompat/content/res/AppCompatResources;->sColorStateCacheLock:Ljava/lang/Object;
    ...
    check-cast v1, Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;

    .line 132
    .local v1, "entry":Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;
    if-eqz v1, :cond_1

    .line 133
    iget-object v2, v1, Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;->configuration:Landroid/content/res/Configuration;
    ...
    .line 135
    iget-object v2, v1, Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;->value:Landroid/content/res/ColorStateList;

    monitor-exit v3

    .line 143
    .end local v1    # "entry":Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;
    :goto_0
    return-object v2

    .line 138
    .restart local v1    # "entry":Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;
    :cond_0
...
.method private static inflateColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, v2, v4}, Landroidx/core/content/res/ColorStateListInflaterCompat;->createFromXml(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    :try_end_0
