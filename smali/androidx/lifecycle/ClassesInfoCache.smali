...
.method private createInfo(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    .line 106
    .local v8, "handlerToEvent":Ljava/util/Map;, "Ljava/util/Map<Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;>;"
    if-eqz v18, :cond_0
    ...
    .line 108
    .local v17, "superInfo":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    if-eqz v17, :cond_0
    ...
    .line 113
    .end local v17    # "superInfo":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    :cond_0
    ...
    invoke-virtual {v0, v12}, Landroidx/lifecycle/ClassesInfoCache;->getInfo(Ljava/lang/Class;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    .line 117
    .local v6, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;>;"
    invoke-interface {v6}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;

    move-result-object v19

    check-cast v19, Landroidx/lifecycle/ClassesInfoCache$MethodReference;
    ...
    invoke-direct {v0, v8, v1, v2, v3}, Landroidx/lifecycle/ClassesInfoCache;->verifyAndPutHandler(Ljava/util/Map;Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V

    goto :goto_1

    .line 114
    .end local v6    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;>;"
    :cond_1
    ...
    const-class v21, Landroidx/lifecycle/OnLifecycleEvent;
    ...
    .line 125
    .local v4, "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    if-nez v4, :cond_4
    ...
    .line 121
    .end local v4    # "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    ...
    .line 128
    .restart local v4    # "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    ...
    const-class v22, Landroidx/lifecycle/LifecycleOwner;
    ...
    .line 138
    :cond_5
    invoke-interface {v4}, Landroidx/lifecycle/OnLifecycleEvent;->value()Landroidx/lifecycle/Lifecycle$Event;
    ...
    const-class v22, Landroidx/lifecycle/Lifecycle$Event;
    ...
    .line 146
    :cond_6
    sget-object v21, Landroidx/lifecycle/Lifecycle$Event;->ON_ANY:Landroidx/lifecycle/Lifecycle$Event;
    ...
    .line 154
    :cond_8
    new-instance v14, Landroidx/lifecycle/ClassesInfoCache$MethodReference;

    invoke-direct {v14, v5, v13}, Landroidx/lifecycle/ClassesInfoCache$MethodReference;-><init>(ILjava/lang/reflect/Method;)V

    .line 155
    .local v14, "methodReference":Landroidx/lifecycle/ClassesInfoCache$MethodReference;
    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v8, v14, v7, v1}, Landroidx/lifecycle/ClassesInfoCache;->verifyAndPutHandler(Ljava/util/Map;Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V
    ...
    .end local v13    # "method":Ljava/lang/reflect/Method;
    .end local v14    # "methodReference":Landroidx/lifecycle/ClassesInfoCache$MethodReference;
    .end local v16    # "params":[Ljava/lang/Class;, "[Ljava/lang/Class<*>;"
    :cond_9
    new-instance v10, Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;

    invoke-direct {v10, v8}, Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;-><init>(Ljava/util/Map;)V
...
.method getInfo(Ljava/lang/Class;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    .line 85
    .end local v0    # "existing":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    .local v1, "existing":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    :goto_0
    return-object v1

    .line 84
    .end local v1    # "existing":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    .restart local v0    # "existing":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    :cond_0
    const/4 v2, 0x0

    invoke-direct {p0, p1, v2}, Landroidx/lifecycle/ClassesInfoCache;->createInfo(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    .line 85
    .end local v0    # "existing":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    .restart local v1    # "existing":Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    goto :goto_0
.end method
...
.method hasLifecycleMethods(Ljava/lang/Class;)Z
    ...
    .line 45
    iget-object v4, p0, Landroidx/lifecycle/ClassesInfoCache;->mHasLifecycleMethods:Ljava/util/Map;
    ...
    .line 46
    iget-object v3, p0, Landroidx/lifecycle/ClassesInfoCache;->mHasLifecycleMethods:Ljava/util/Map;
    ...
    .line 52
    .local v0, "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    if-eqz v0, :cond_1
    ...
    .line 63
    .end local v0    # "annotation":Landroidx/lifecycle/OnLifecycleEvent;
    .end local v1    # "method":Ljava/lang/reflect/Method;
    :cond_2
    iget-object v4, p0, Landroidx/lifecycle/ClassesInfoCache;->mHasLifecycleMethods:Ljava/util/Map;
