...
.method private createPopup()Landroidx/appcompat/view/menu/MenuPopup;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/appcompat/view/menu/CascadingMenuPopup;-><init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    .line 232
    .end local v0    # "popup":Landroidx/appcompat/view/menu/MenuPopup;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/appcompat/view/menu/StandardMenuPopup;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/View;IIZ)V

    .restart local v0    # "popup":Landroidx/appcompat/view/menu/MenuPopup;
    goto :goto_2
.end method
...
.method private showPopup(IIZZ)V
    ...
    .line 264
    .local v4, "popup":Landroidx/appcompat/view/menu/MenuPopup;
    invoke-virtual {v4, p4}, Landroidx/appcompat/view/menu/MenuPopup;->setShowTitle(Z)V

    .line 266
    if-eqz p3, :cond_1

    .line 270
    iget v5, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mDropDownGravity:I
    ...
    .line 276
    :cond_0
    invoke-virtual {v4, p1}, Landroidx/appcompat/view/menu/MenuPopup;->setHorizontalOffset(I)V

    .line 277
    invoke-virtual {v4, p2}, Landroidx/appcompat/view/menu/MenuPopup;->setVerticalOffset(I)V
    ...
    invoke-virtual {v4, v1}, Landroidx/appcompat/view/menu/MenuPopup;->setEpicenterBounds(Landroid/graphics/Rect;)V
    ...
    :cond_1
    invoke-virtual {v4}, Landroidx/appcompat/view/menu/MenuPopup;->show()V
...
.method public tryShow()Z
    ...
    .line 177
    :cond_1
    invoke-direct {p0, v1, v1, v1, v1}, Landroidx/appcompat/view/menu/MenuPopupHelper;->showPopup(IIZZ)V
...
.method public tryShow(II)Z
    ...
    .line 213
    :cond_1
    invoke-direct {p0, p1, p2, v0, v0}, Landroidx/appcompat/view/menu/MenuPopupHelper;->showPopup(IIZZ)V
