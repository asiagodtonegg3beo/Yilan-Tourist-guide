...
.field private final this$0:Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep;
...
.method public constructor <init>(Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep;)V
    ...
    iput v0, p0, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->integer:I
...
.method static access$000(Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;)I
    .locals 1
...
.method static access$002(Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;I)I
    .locals 0
    .param p0, "x0"    # Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
    .param p1, "x1"    # I
...
.method public postMortem(Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/PostMortem;)Z
    ...
    check-cast v2, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;

    .line 80
    .local v2, "that":Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
    if-nez v2, :cond_1
    ...
    .line 84
    :cond_1
    iget v5, p0, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->integer:I

    iget v6, v2, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->integer:I
    ...
    iget v5, v2, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->integer:I
    ...
    .line 89
    :cond_2
    iget-object v5, p0, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->next:[Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;

    if-nez v5, :cond_4

    .line 90
    iget-object v5, v2, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->next:[Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
    ...
    .line 98
    .local v1, "node":Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
    if-eqz v1, :cond_6
    ...
    invoke-virtual {v1, v5}, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->postMortem(Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/PostMortem;)Z
    ...
    .end local v1    # "node":Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
    :cond_7
    move v3, v4
...
.method public vet(I)Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
    ...
    iget-object v1, p0, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;->this$0:Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep;

    invoke-direct {v0, v1}, Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;-><init>(Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep;)V

    .line 154
    .restart local v0    # "node":Lcom/google/appinventor/components/runtime/repackaged/org/json/zip/TrieKeep$Node;
