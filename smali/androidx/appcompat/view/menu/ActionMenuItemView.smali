...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v3, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mAllowTextWithIcon:Z

    .line 75
    sget-object v3, Landroidx/appcompat/R$styleable;->ActionMenuItemView:[I
    ...
    .line 87
    invoke-virtual {p0, v5}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setSaveEnabled(Z)V
...
.method private updateTextButtonVisibility()V
    ...
    .line 188
    iget-object v6, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mTitle:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mItemData:Landroidx/appcompat/view/menu/MenuItemImpl;

    .line 190
    invoke-virtual {v6}, Landroidx/appcompat/view/menu/MenuItemImpl;->showsTextAsAction()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-boolean v6, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mAllowTextWithIcon:Z

    if-nez v6, :cond_0

    iget-boolean v6, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mExpandedFormat:Z
...
.method protected onMeasure(II)V
    ...
    iget v7, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mSavedPaddingLeft:I
    ...
    iget v7, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mMinWidth:I
    ...
    invoke-super {p0, v7, p2}, Landroidx/appcompat/widget/AppCompatTextView;->onMeasure(II)V

    .line 289
    :cond_1
    if-nez v3, :cond_2

    iget-object v7, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->mIcon:Landroid/graphics/drawable/Drawable;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_2
    invoke-virtual {p0, p1, v5, v5, v5}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
