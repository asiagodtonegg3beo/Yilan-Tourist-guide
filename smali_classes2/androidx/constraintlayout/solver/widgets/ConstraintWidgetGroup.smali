...
.method constructor <init>(Ljava/util/List;)V
    ...
    .line 40
    iput-boolean v2, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mSkipSolver:Z
    ...
    iget v1, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mGroupWidth:I

    aput v1, v0, v2

    const/4 v1, 0x1

    iget v2, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mGroupHeight:I
...
.method private getWidgetsToSolveTraversal(Ljava/util/ArrayList;Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
    ...
    iget-boolean v6, p2, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mGroupsToSolver:Z
    ...
    iput-boolean v6, p2, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mGroupsToSolver:Z
    ...
    .line 130
    instance-of v6, p2, Landroidx/constraintlayout/solver/widgets/Helper;
    ...
    .line 132
    .local v1, "helper":Landroidx/constraintlayout/solver/widgets/Helper;
    iget v5, v1, Landroidx/constraintlayout/solver/widgets/Helper;->mWidgetsCount:I
    ...
    .line 134
    iget-object v6, v1, Landroidx/constraintlayout/solver/widgets/Helper;->mWidgets:[Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    aget-object v6, v6, v2

    invoke-direct {p0, p1, v6}, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->getWidgetsToSolveTraversal(Ljava/util/ArrayList;Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
    ...
    .line 138
    .end local v1    # "helper":Landroidx/constraintlayout/solver/widgets/Helper;
    .end local v2    # "i":I
    .end local v5    # "widgetCount":I
    :cond_2
    iget-object v6, p2, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mListAnchors:[Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;
    ...
    .line 142
    .local v4, "targetWidget":Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    if-eqz v3, :cond_3
...
.method private updateResolvedDimension(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;)V
    ...
    .line 174
    .local v1, "end":I
    iget-boolean v6, p1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mOptimizerMeasurable:Z
    ...
    .line 189
    iget-object v6, v4, Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;->mOwner:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 192
    :cond_2
    iget-object v6, v4, Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;->mType:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor$Type;
    ...
    .line 204
    invoke-virtual {p1, v3, v1}, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->setHorizontalDimension(II)V
    ...
    iget v7, p1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mBaselineDistance:I

    sub-int v3, v6, v7

    .line 213
    iget v6, p1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mHeight:I

    add-int v1, v3, v6

    .line 214
    invoke-virtual {p1, v3, v1}, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->setVerticalDimension(II)V

    .line 215
    iput-boolean v5, p1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->mOptimizerMeasured:Z
    ...
    .restart local v4    # "targetAnchor":Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;
    goto :goto_2
...
.method getWidgetsToSolve()Ljava/util/List;
    ...
    .line 102
    :cond_0
    iget-object v3, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mConstrainedGroup:Ljava/util/List;
    ...
    :cond_2
    iget-object v3, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mUnresolvedWidgets:Ljava/util/List;
    ...
    iget-object v4, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mConstrainedGroup:Ljava/util/List;
    ...
    iget-object v4, p0, Landroidx/constraintlayout/solver/widgets/ConstraintWidgetGroup;->mWidgetsToSolve:Ljava/util/List;
