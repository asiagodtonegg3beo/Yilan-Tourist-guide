...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPendingMenus:Ljava/util/List;
    ...
    iput-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShowingMenus:Ljava/util/List;

    .line 97
    new-instance v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$1;

    invoke-direct {v1, p0}, Landroidx/appcompat/view/menu/CascadingMenuPopup$1;-><init>(Landroidx/appcompat/view/menu/CascadingMenuPopup;)V

    iput-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    .line 119
    new-instance v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$2;

    invoke-direct {v1, p0}, Landroidx/appcompat/view/menu/CascadingMenuPopup$2;-><init>(Landroidx/appcompat/view/menu/CascadingMenuPopup;)V

    iput-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;

    .line 137
    new-instance v1, Landroidx/appcompat/view/menu/CascadingMenuPopup$3;

    invoke-direct {v1, p0}, Landroidx/appcompat/view/menu/CascadingMenuPopup$3;-><init>(Landroidx/appcompat/view/menu/CascadingMenuPopup;)V

    iput-object v1, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mMenuItemHoverListener:Landroidx/appcompat/widget/MenuItemHoverListener;

    .line 197
    iput v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mRawDropDownGravity:I

    .line 198
    iput v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mDropDownGravity:I
    ...
    .line 229
    iput-boolean v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mForceShowIcon:Z
...
.method private createPopupWindow()Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    iget v4, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPopupStyleRes:I

    invoke-direct {v0, v1, v2, v3, v4}, Landroidx/appcompat/widget/MenuPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private findIndexOfAddedMenu(Landroidx/appcompat/view/menu/MenuBuilder;)I
    ...
    .restart local v2    # "info":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    :cond_0
...
.method private findParentViewForSubmenu(Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/View;
    ...
    .line 537
    iget-object v11, p1, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-direct {p0, v11, p2}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->findMenuItemForSubmenu(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/MenuItem;
    ...
    .local v6, "menuAdapter":Landroidx/appcompat/view/menu/MenuAdapter;
    :goto_1
    const/4 v8, -0x1
    ...
    .line 560
    invoke-virtual {v6, v3}, Landroidx/appcompat/view/menu/MenuAdapter;->getItem(I)Landroidx/appcompat/view/menu/MenuItemImpl;
    ...
    .end local v3    # "i":I
    .end local v6    # "menuAdapter":Landroidx/appcompat/view/menu/MenuAdapter;
    ...
    .restart local v6    # "menuAdapter":Landroidx/appcompat/view/menu/MenuAdapter;
    goto :goto_1
...
.method private getInitialMenuPosition()I
    ...
    .line 315
    iget-object v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mAnchorView:Landroid/view/View;
...
.method private getNextMenuPosition(I)I
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->getListView()Landroid/widget/ListView;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShownAnchorView:Landroid/view/View;

    invoke-virtual {v5, v0}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    .line 337
    iget v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mLastPosition:I
...
.method private showMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    sget v22, Landroidx/appcompat/view/menu/CascadingMenuPopup;->ITEM_LAYOUT:I
    ...
    invoke-direct {v3, v0, v6, v1, v2}, Landroidx/appcompat/view/menu/MenuAdapter;-><init>(Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/LayoutInflater;ZI)V
    ...
    iget-boolean v0, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mForceShowIcon:Z
    ...
    invoke-virtual {v3, v0}, Landroidx/appcompat/view/menu/MenuAdapter;->setForceShowIcon(Z)V
    ...
    invoke-static {v3, v0, v1, v2}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    .line 387
    .local v16, "popupWindow":Landroidx/appcompat/widget/MenuPopupWindow;
    move-object/from16 v0, v16

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/MenuPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 388
    move-object/from16 v0, v16

    invoke-virtual {v0, v9}, Landroidx/appcompat/widget/MenuPopupWindow;->setContentWidth(I)V
    ...
    .line 395
    .local v11, "parentInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v11, v1}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->findParentViewForSubmenu(Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setTouchModal(Z)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setEnterTransition(Ljava/lang/Object;)V

    .line 406
    move-object/from16 v0, p0

    invoke-direct {v0, v9}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->getNextMenuPosition(I)I
    ...
    invoke-virtual {v0, v14}, Landroidx/appcompat/widget/MenuPopupWindow;->setAnchorView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setHorizontalOffset(I)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setOverlapAnchor(Z)V

    .line 471
    move-object/from16 v0, v16

    invoke-virtual {v0, v13}, Landroidx/appcompat/widget/MenuPopupWindow;->setVerticalOffset(I)V
    ...
    .end local v20    # "x":I
    :goto_5
    new-instance v8, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    ...
    invoke-direct {v8, v0, v1, v2}, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;-><init>(Landroidx/appcompat/widget/MenuPopupWindow;Landroidx/appcompat/view/menu/MenuBuilder;I)V

    .line 484
    .local v8, "menuInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    move-object/from16 v0, p0
    ...
    .line 486
    invoke-virtual/range {v16 .. v16}, Landroidx/appcompat/widget/MenuPopupWindow;->show()V

    .line 488
    invoke-virtual/range {v16 .. v16}, Landroidx/appcompat/widget/MenuPopupWindow;->getListView()Landroid/widget/ListView;
    ...
    .line 493
    sget v21, Landroidx/appcompat/R$layout;->abc_popup_menu_header_item_layout:I
    ...
    .end local v8    # "menuInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    .end local v9    # "menuWidth":I
    .end local v11    # "parentInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    .end local v14    # "parentView":Landroid/view/View;
    .end local v16    # "popupWindow":Landroidx/appcompat/widget/MenuPopupWindow;
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->isShowing()Z
    ...
    .restart local v16    # "popupWindow":Landroidx/appcompat/widget/MenuPopupWindow;
    :cond_3
    const/4 v11, 0x0

    .line 398
    .restart local v11    # "parentInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    const/4 v14, 0x0
    ...
    iget-boolean v0, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mHasXOffset:Z
    ...
    iget-boolean v0, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mHasYOffset:Z
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setVerticalOffset(I)V
    ...
    invoke-virtual {v0, v5}, Landroidx/appcompat/widget/MenuPopupWindow;->setEpicenterBounds(Landroid/graphics/Rect;)V
...
.method public dismiss()V
    ...
    new-array v5, v3, [Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    ...
    .line 291
    .local v0, "addedMenus":[Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    ...
    .line 298
    .end local v0    # "addedMenus":[Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    .end local v1    # "i":I
    .end local v2    # "info":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    :cond_1
    return-void
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    .line 676
    .local v0, "childInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    iget-object v6, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v6, v8}, Landroidx/appcompat/view/menu/MenuBuilder;->close(Z)V

    .line 680
    .end local v0    # "childInfo":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    :cond_2
    iget-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShowingMenus:Ljava/util/List;
    ...
    .line 681
    .local v2, "info":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    iget-object v6, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v6, p0}, Landroidx/appcompat/view/menu/MenuBuilder;->removeMenuPresenter(Landroidx/appcompat/view/menu/MenuPresenter;)V

    .line 682
    iget-boolean v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShouldCloseImmediately:Z

    if-eqz v6, :cond_3

    .line 684
    iget-object v6, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v6, v9}, Landroidx/appcompat/widget/MenuPopupWindow;->setExitTransition(Ljava/lang/Object;)V

    .line 685
    iget-object v6, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v6, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setAnimationStyle(I)V

    .line 687
    :cond_3
    iget-object v6, v2, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v6}, Landroidx/appcompat/widget/MenuPopupWindow;->dismiss()V
    ...
    .line 700
    iget-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/MenuPresenter$Callback;
    ...
    invoke-interface {v6, p1, v7}, Landroidx/appcompat/view/menu/MenuPresenter$Callback;->onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V

    .line 704
    :cond_4
    iget-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object v7, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    .line 708
    :cond_5
    iput-object v9, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;

    .line 710
    :cond_6
    iget-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShownAnchorView:Landroid/view/View;

    iget-object v7, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
    ...
    .line 714
    iget-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    .line 630
    .local v0, "info":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    iget-object v3, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    .line 645
    .end local v0    # "info":Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    :cond_1
    :goto_0
    return v1
    ...
    .line 640
    iget-object v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/MenuPresenter$Callback;
    ...
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/MenuPresenter$Callback;->onOpenSubMenu(Landroidx/appcompat/view/menu/MenuBuilder;)Z
...
.method public show()V
    ...
    .line 264
    :cond_1
    iget-object v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPendingMenus:Ljava/util/List;
    ...
    iput-object v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShownAnchorView:Landroid/view/View;

    .line 271
    iget-object v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShownAnchorView:Landroid/view/View;

    if-eqz v2, :cond_0

    .line 272
    iget-object v2, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
