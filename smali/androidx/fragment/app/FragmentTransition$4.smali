...
.method public run()V
    ...
    iget-object v3, p0, Landroidx/fragment/app/FragmentTransition$4;->val$nameOverrides:Landroidx/collection/ArrayMap;

    iget-object v4, p0, Landroidx/fragment/app/FragmentTransition$4;->val$finalSharedElementTransition:Ljava/lang/Object;

    iget-object v5, p0, Landroidx/fragment/app/FragmentTransition$4;->val$fragments:Landroidx/fragment/app/FragmentTransition$FragmentContainerTransition;

    invoke-static {v2, v3, v4, v5}, Landroidx/fragment/app/FragmentTransition;->captureInSharedElements(Landroidx/fragment/app/FragmentTransitionImpl;Landroidx/collection/ArrayMap;Ljava/lang/Object;Landroidx/fragment/app/FragmentTransition$FragmentContainerTransition;)Landroidx/collection/ArrayMap;
    ...
    .line 741
    iget-object v2, p0, Landroidx/fragment/app/FragmentTransition$4;->val$sharedElementsIn:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Landroidx/fragment/app/FragmentTransition$4;->val$nonExistentView:Landroid/view/View;
    ...
    iget-object v3, p0, Landroidx/fragment/app/FragmentTransition$4;->val$outFragment:Landroidx/fragment/app/Fragment;

    iget-boolean v4, p0, Landroidx/fragment/app/FragmentTransition$4;->val$inIsPop:Z

    const/4 v5, 0x0

    invoke-static {v2, v3, v4, v1, v5}, Landroidx/fragment/app/FragmentTransition;->callSharedElementStartEnd(Landroidx/fragment/app/Fragment;Landroidx/fragment/app/Fragment;ZLandroidx/collection/ArrayMap;Z)V
    ...
    iget-object v3, p0, Landroidx/fragment/app/FragmentTransition$4;->val$finalSharedElementTransition:Ljava/lang/Object;

    iget-object v4, p0, Landroidx/fragment/app/FragmentTransition$4;->val$sharedElementsOut:Ljava/util/ArrayList;

    iget-object v5, p0, Landroidx/fragment/app/FragmentTransition$4;->val$sharedElementsIn:Ljava/util/ArrayList;

    invoke-virtual {v2, v3, v4, v5}, Landroidx/fragment/app/FragmentTransitionImpl;->swapSharedElementTargets(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    .line 752
    iget-object v2, p0, Landroidx/fragment/app/FragmentTransition$4;->val$fragments:Landroidx/fragment/app/FragmentTransition$FragmentContainerTransition;

    iget-object v3, p0, Landroidx/fragment/app/FragmentTransition$4;->val$enterTransition:Ljava/lang/Object;

    iget-boolean v4, p0, Landroidx/fragment/app/FragmentTransition$4;->val$inIsPop:Z

    invoke-static {v1, v2, v3, v4}, Landroidx/fragment/app/FragmentTransition;->getInEpicenterView(Landroidx/collection/ArrayMap;Landroidx/fragment/app/FragmentTransition$FragmentContainerTransition;Ljava/lang/Object;Z)Landroid/view/View;
    ...
    invoke-virtual {v2, v0, v3}, Landroidx/fragment/app/FragmentTransitionImpl;->getBoundsOnScreen(Landroid/view/View;Landroid/graphics/Rect;)V
