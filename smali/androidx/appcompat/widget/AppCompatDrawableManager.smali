...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v7}, Landroidx/appcompat/widget/AppCompatDrawableManager$ColorFilterLruCache;-><init>(I)V
    ...
    sget v1, Landroidx/appcompat/R$drawable;->abc_ic_menu_paste_mtrl_am_alpha:I
    ...
    sget v1, Landroidx/appcompat/R$drawable;->abc_text_select_handle_right_mtrl_dark:I
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTintLists:Ljava/util/WeakHashMap;
...
.method private checkVectorDrawableSetup(Landroid/content/Context;)V
    ...
    .prologue
    .line 746
    iget-boolean v1, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mHasCheckedVectorDrawableSetup:Z
    ...
    .line 753
    sget v1, Landroidx/appcompat/R$drawable;->abc_vector_test:I
...
.method private createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 231
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;
    ...
    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;

    .line 234
    :cond_0
    iget-object v4, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;
    ...
    .line 236
    invoke-static {v4}, Landroidx/appcompat/widget/AppCompatDrawableManager;->createCacheKey(Landroid/util/TypedValue;)J

    move-result-wide v2

    .line 238
    .local v2, "key":J
    invoke-direct {p0, p1, v2, v3}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    sget v7, Landroidx/appcompat/R$drawable;->abc_cab_background_internal_bg:I
    ...
    .line 255
    invoke-direct {p0, p1, v2, v3, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager;->addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private declared-synchronized getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v4, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDrawableCaches:Ljava/util/WeakHashMap;
...
.method public static declared-synchronized getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager$ColorFilterLruCache;->put(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private getTintListFromCache(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 559
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTintLists:Ljava/util/WeakHashMap;
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v14, v0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mDelegates:Landroidx/collection/ArrayMap;
    ...
    iget-object v14, v0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroidx/collection/SparseArrayCompat;
    ...
    iput-object v14, v0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroidx/collection/SparseArrayCompat;

    .line 326
    :cond_3
    move-object/from16 v0, p0

    iget-object v14, v0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;
    ...
    iput-object v14, v0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;

    .line 329
    :cond_4
    move-object/from16 v0, p0

    iget-object v12, v0, Landroidx/appcompat/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;
    ...
    .line 333
    invoke-static {v12}, Landroidx/appcompat/widget/AppCompatDrawableManager;->createCacheKey(Landroid/util/TypedValue;)J
    ...
    invoke-direct {v0, v1, v8, v9}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    check-cast v4, Landroidx/appcompat/widget/AppCompatDrawableManager$InflateDelegate;

    .line 365
    .local v4, "delegate":Landroidx/appcompat/widget/AppCompatDrawableManager$InflateDelegate;
    if-eqz v4, :cond_9
    ...
    invoke-interface {v4, v0, v7, v2, v14}, Landroidx/appcompat/widget/AppCompatDrawableManager$InflateDelegate;->createFromXmlInner(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v1, v8, v9, v5}, Landroidx/appcompat/widget/AppCompatDrawableManager;->addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    :try_end_1
    ...
    .line 389
    .end local v2    # "attrs":Landroid/util/AttributeSet;
    .end local v4    # "delegate":Landroidx/appcompat/widget/AppCompatDrawableManager$InflateDelegate;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 270
    invoke-static {p4, v1}, Landroidx/core/graphics/drawable/DrawableCompat;->setTintList(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 275
    invoke-static {p4, v2}, Landroidx/core/graphics/drawable/DrawableCompat;->setTintMode(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method static tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 447
    .local v0, "alpha":I
    sget-object v5, Landroidx/appcompat/widget/AppCompatDrawableManager;->COLORFILTER_TINT_COLOR_CONTROL_NORMAL:[I

    invoke-static {v5, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager;->arrayContains([II)Z
    ...
    .line 450
    :cond_3
    sget-object v5, Landroidx/appcompat/widget/AppCompatDrawableManager;->COLORFILTER_COLOR_CONTROL_ACTIVATED:[I
    ...
    .line 453
    :cond_4
    sget-object v5, Landroidx/appcompat/widget/AppCompatDrawableManager;->COLORFILTER_COLOR_BACKGROUND_MULTIPLY:[I
